/**
 * All this data is rendered in the DataTable, Map, Cards, Accordion
 * The UI will use information in this metadata to fetch the actual contents of the miracle
 * Such as the intro, overview, images, etc.
 * Could move this to the backend
 */
import {
